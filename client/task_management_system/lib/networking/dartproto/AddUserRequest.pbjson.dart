...
const AddUserRequest$json = {
  '1': 'AddUserRequest',
  '2': [
    {'1': 'verification', '3': 1, '4': 1, '5': 11, '6': '.taskmanager.pb.InitialVerification', '10': 'verification'},
  ],
};
...
final $typed_data.Uint8List addUserRequestDescriptor = $convert.base64Decode(
    'Cg5BZGRVc2VyUmVxdWVzdBJHCgx2ZXJpZmljYXRpb24YASABKAsyIy50YXNrbWFuYWdlci5wYi'
    '5Jbml0aWFsVmVyaWZpY2F0aW9uUgx2ZXJpZmljYXRpb24=');
